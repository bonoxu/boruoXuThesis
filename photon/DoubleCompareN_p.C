...
//=========  (Mon Mar 20 15:37:59 2017) by ROOT version5.34/05
   TCanvas *c1 = new TCanvas("c1", "",12,51,800,700);
   gStyle->SetOptStat(0);
   c1->Range(-8.692308,-0.3513514,33.61538,4.378378);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   Graph_Graph2->SetMinimum(2.534013);
   Graph_Graph2->SetMaximum(3.982693);
   ...
   Graph_Graph_Graph24->SetMinimum(2.534013);
   Graph_Graph_Graph24->SetMaximum(3.982693);
   ...
   TLegend *leg = new TLegend(0.6030151,0.21875,0.9836683,0.3690476,NULL,"brNDC");
   leg->SetBorderSize(0);
