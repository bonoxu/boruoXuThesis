...
//=========  (Wed Jul 12 10:11:54 2017) by ROOT version5.34/05
   ...
   Graph_Graph1->SetMinimum(3.642897);
   Graph_Graph1->SetMaximum(6.889076);
   ...
   Graph_Graph2->SetMinimum(0.869517);
   Graph_Graph2->SetMaximum(2.600729);
   ...
   Graph_Graph3->SetMaximum(3.055629);
   ...
   Graph_Graph4->SetMaximum(2.447066);
   ...
   Graph_Graph_Graph15->SetMinimum(3.642897);
   Graph_Graph_Graph15->SetMaximum(6.889076);
   ...
   Graph_Graph_Graph26->SetMinimum(0.869517);
   Graph_Graph_Graph26->SetMaximum(2.600729);
   ...
   Graph_Graph_Graph37->SetMaximum(3.055629);
   ...
   Graph_Graph_Graph48->SetMaximum(2.447066);
   ...
   TLegend *leg = new TLegend(0.169598,0.7589286,0.5502513,0.9092262,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   entry->SetMarkerStyle(21);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("2","ECAL Frag Removal","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerStyle(21);
   entry->SetMarkerSize(1);
   entry=leg->AddEntry("3","E/HCAL Frag Removal","f");
   entry->SetFillStyle(1001);
