...
Projective likelihood model  with probability density estimators is used in \pandora for the photon ID due to its simplicity and low requirement on computing resources. Its details are described in \Section{sec:pandoraLikelihood}.
