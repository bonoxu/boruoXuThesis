...
Positions of the photon algorithms used  in the \pandora are shown in \Figure{fig:photonPhotonAlgs}. The five photon algorithms are highlighted in red. Samples used to produce figures in this chapter were simulated with the \ILD detector model.
...
\centering
  ...
  \end{subfigure}
\caption
{The energies of the second most energetic reconstructed photon in a) the photon$-$photon-fragment pairs, and the true photon$-$photon pairs , and in b) the  photon$-$neutral-fragment pairs, and the true photon$-$neutral-hadron pairs.}
...
\centering
  ...
  \end{subfigure}
\caption
{Distributions of  distances between centroids, $d_c$, for: a) photon$-$neutral-fragment pairs and the true photon$-$neutral-hadron pairs for low-energy fragments; and b) photon$-$neutral-fragment pairs and the true photon$-$neutral-hadron pairs for high-energy fragments.}
