...
This algorithm uses photons in the \ECAL and neutral hadrons in the \HCAL as inputs. It then considers all pairs of reconstructed photons and neutral hadrons. Photon$-$fragment pairs passing all the cuts will be merged.
