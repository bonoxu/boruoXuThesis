...
\centering
  ...
  \end{subfigure}
\caption
{Variables for photon ID test, obtained from simulated 500\,GeV di-jet \Zuds events. Photon ID in plots are determined using MC information. \FIGURE{fig:photonLongProfileStart}, }
