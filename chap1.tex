...
In \Chapter{chap:Reconstruction}, the software for event simulation, event reconstruction, and event analysis is  discussed.  \pandora, a world-leading pattern-recognition software for particle flow calorimetry is presented. A discussion of jet algorithms is provided followed by a discussion on  multivariate analysis, where different fitting models, optimisation, and overfitting are described in detail.

% The multivariate analysis is used extensively in \Chapter{chap:Photon}, \Chapter{chap:Tau}, and \Chapter{chap:DoubleHiggs}.
...
Analyses presented in \Chapter{chap:Photon},  \Chapter{chap:Tau}, and  \Chapter{chap:Tau2Mini} are solely my own work. The analysis in  \Chapter{chap:DoubleHiggs} was collaborated with two researchers from \CERN. Contribution from collaborators was clearly indicated in the text.
