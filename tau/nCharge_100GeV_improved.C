...
//=========  (Tue Aug  1 16:42:52 2017) by ROOT version5.34/05
   ...
   3->SetBinContent(1,0.0002882623);
   3->SetBinContent(2,0.0002882623);
   3->SetBinContent(3,0.01558532);
   3->SetBinContent(4,0.9508801);
   3->SetBinContent(5,0.02042833);
   3->SetBinContent(6,0.008974537);
   3->SetBinContent(7,0.00355523);
   3->SetBinContent(8,0.002978708);
   3->SetMinimum(0);
   3->SetMaximum(0);
   3->SetEntries(52165);
   3->SetStats(0);
