...
//=========  (Wed Oct 19 17:32:33 2016) by ROOT version5.34/05
   ...
   0->SetBinContent(2,0.0001125389);
   0->SetMinimum(0);
   0->SetMaximum(1);
   0->SetEntries(231351);
   0->SetStats(0);
   ...
   ci = TColor::GetColor("#7293cb");
   0->SetLineColor(ci);
   0->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   1->SetBinContent(1,0.005763198);
   1->SetBinContent(2,0.9941401);
   1->SetBinContent(3,9.671219e-05);
   1->SetMinimum(0);
   1->SetMaximum(1);
   1->SetEntries(227791);
   1->SetStats(0);
   ...
   ci = TColor::GetColor("#e1974c");
   1->SetLineColor(ci);
   1->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   2->SetBinContent(1,0.994501);
   2->SetBinContent(2,0.005499);
   2->SetMinimum(0);
   2->SetMaximum(1);
   2->SetEntries(150777);
   2->SetStats(0);
   ...
   ci = TColor::GetColor("#83ba5b");
   2->SetLineColor(ci);
   2->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   3->SetBinContent(1,0.9914402);
   3->SetBinContent(2,0.008550114);
   3->SetBinContent(3,9.705324e-06);
   3->SetMinimum(0);
   3->SetMaximum(1);
   3->SetEntries(309811);
   3->SetStats(0);
   ...
   ci = TColor::GetColor("#d35e60");
   3->SetLineColor(ci);
   3->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   ci = TColor::GetColor("#808585");
   4->SetLineColor(ci);
   4->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   5->SetBinContent(1,0.976279);
   5->SetBinContent(2,0.02356234);
   5->SetBinContent(3,0.0001586722);
   5->SetMinimum(0);
   5->SetMaximum(1);
   5->SetEntries(138860);
   5->SetStats(0);
   ...
   ci = TColor::GetColor("#9067a7");
   5->SetLineColor(ci);
   5->GetXaxis()->SetTitle("Number of #mu^{-}");
   ...
   6->SetBinContent(1,0.9714127);
   6->SetBinContent(2,0.02837658);
   6->SetBinContent(3,0.0002107609);
   6->SetMinimum(0);
   6->SetMaximum(1);
   6->SetEntries(52165);
   6->SetStats(0);
   ...
   ci = TColor::GetColor("#ab6857");
   6->SetLineColor(ci);
   6->GetXaxis()->SetTitle("Number of #mu^{-}");
