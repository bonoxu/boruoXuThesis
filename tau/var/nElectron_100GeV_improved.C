...
//=========  (Wed Oct 19 17:32:28 2016) by ROOT version5.34/05
   ...
   3->SetBinContent(1,0.972494);
   3->SetBinContent(2,0.02595979);
   3->SetBinContent(3,0.00146209);
   3->SetBinContent(4,7.763279e-05);
   3->SetBinContent(5,6.469398e-06);
   3->SetMinimum(0);
   3->SetMaximum(1);
   3->SetEntries(309811);
   3->SetStats(0);
   ...
   4->SetBinContent(1,0.9715762);
   4->SetBinContent(2,0.02713038);
   4->SetBinContent(3,0.00121543);
   4->SetBinContent(4,6.690438e-05);
   4->SetBinContent(5,1.115073e-05);
   4->SetMinimum(0);
   4->SetMaximum(1);
   4->SetEntries(89589);
   4->SetStats(0);
   ...
   ci = TColor::GetColor("#808585");
   4->SetLineColor(ci);
   4->GetXaxis()->SetTitle("Number of e^{-}");
   ...
   5->SetBinContent(1,0.9218524);
   5->SetBinContent(2,0.07416002);
   5->SetBinContent(3,0.003677564);
   5->SetBinContent(4,0.0002884347);
   5->SetBinContent(5,2.163261e-05);
   5->SetMinimum(0);
   5->SetMaximum(1);
   5->SetEntries(138860);
   5->SetStats(0);
   ...
   ci = TColor::GetColor("#9067a7");
   5->SetLineColor(ci);
   5->GetXaxis()->SetTitle("Number of e^{-}");
   ...
   6->SetBinContent(1,0.9159048);
   6->SetBinContent(2,0.08012893);
   6->SetBinContent(3,0.003717209);
   6->SetBinContent(4,0.0002490917);
   6->SetMinimum(0);
   6->SetMaximum(1);
   6->SetEntries(52165);
   6->SetStats(0);
   ...
   ci = TColor::GetColor("#ab6857");
   6->SetLineColor(ci);
   6->GetXaxis()->SetTitle("Number of e^{-}");
