...
//=========  (Wed Oct 19 17:10:14 2016) by ROOT version5.34/05
   ...
   0->SetBinContent(1,6.490383e-05);
   0->SetBinContent(2,0.4301999);
   0->SetBinContent(3,0.4167391);
   0->SetBinContent(4,0.1273514);
   0->SetBinContent(5,0.02168989);
   0->SetBinContent(6,0.003418282);
   0->SetBinContent(7,0.0005365384);
   0->SetBinContent(8,0.0001600961);
   0->SetMinimum(0);
   0->SetMaximum(1);
   0->SetEntries(231351);
   0->SetStats(0);
   ...
   ci = TColor::GetColor("#7293cb");
   0->SetLineColor(ci);
   0->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   1->SetBinContent(1,0.000479079);
   1->SetBinContent(2,0.8837022);
   1->SetBinContent(3,0.1061405);
   1->SetBinContent(4,0.008232296);
   1->SetBinContent(5,0.00115594);
   1->SetBinContent(6,0.0002417371);
   1->SetBinContent(7,4.834741e-05);
   1->SetBinContent(8,1.318566e-05);
   1->SetMinimum(0);
   1->SetMaximum(1);
   1->SetEntries(227791);
   1->SetStats(0);
   ...
   ci = TColor::GetColor("#e1974c");
   1->SetLineColor(ci);
   1->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   2->SetBinContent(1,0.0009474334);
   2->SetBinContent(2,0.8583108);
   2->SetBinContent(3,0.1113783);
   2->SetBinContent(4,0.01608592);
   2->SetBinContent(5,0.006074289);
   2->SetBinContent(6,0.004018209);
   2->SetBinContent(7,0.003185007);
   2->SetBinContent(8,0.01194017);
   2->SetMinimum(0);
   2->SetMaximum(1);
   2->SetEntries(150777);
   2->SetStats(0);
   ...
   ci = TColor::GetColor("#83ba5b");
   2->SetLineColor(ci);
   2->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   3->SetBinContent(1,7.18747e-05);
   3->SetBinContent(2,0.001153266);
   3->SetBinContent(3,0.1334198);
   3->SetBinContent(4,0.743735);
   3->SetBinContent(5,0.1010974);
   3->SetBinContent(6,0.01522689);
   3->SetBinContent(7,0.005295813);
   3->SetBinContent(8,0.01163994);
   3->SetMinimum(0);
   3->SetMaximum(1);
   3->SetEntries(309811);
   3->SetStats(0);
   ...
   ci = TColor::GetColor("#d35e60");
   3->SetLineColor(ci);
   3->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   4->SetBinContent(1,5.724745e-05);
   4->SetBinContent(2,0.0002747877);
   4->SetBinContent(3,0.02853285);
   4->SetBinContent(4,0.05248688);
   4->SetBinContent(5,0.225893);
   4->SetBinContent(6,0.6132162);
   4->SetBinContent(7,0.07953904);
   4->SetBinContent(8,0.02581912);
   4->SetMinimum(0);
   4->SetMaximum(1);
   4->SetEntries(89589);
   4->SetStats(0);
   ...
   ci = TColor::GetColor("#808585");
   4->SetLineColor(ci);
   4->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   5->SetBinContent(1,0.0001272304);
   5->SetBinContent(2,0.0002993655);
   5->SetBinContent(3,0.006765618);
   5->SetBinContent(4,0.7832699);
   5->SetBinContent(5,0.1548075);
   5->SetBinContent(6,0.037824);
   5->SetBinContent(7,0.01690637);
   5->SetBinContent(8,0.03858736);
   5->SetMinimum(0);
   5->SetMaximum(1);
   5->SetEntries(138860);
   5->SetStats(0);
   ...
   ci = TColor::GetColor("#9067a7");
   5->SetLineColor(ci);
   5->GetXaxis()->SetTitle("N_{charged+#gamma}");
   ...
   6->SetBinContent(1,0.0001032237);
   6->SetBinContent(2,0.0001651579);
   6->SetBinContent(3,0.0002064474);
   6->SetBinContent(4,0.001919963);
   6->SetBinContent(5,0.1125516);
   6->SetBinContent(6,0.7382542);
   6->SetBinContent(7,0.1467994);
   6->SetBinContent(8,0.07725099);
   6->SetMinimum(0);
   6->SetMaximum(1);
   6->SetEntries(52165);
   6->SetStats(0);
   ...
   ci = TColor::GetColor("#ab6857");
   6->SetLineColor(ci);
   6->GetXaxis()->SetTitle("N_{charged+#gamma}");
