...
//=========  (Wed Oct 19 17:32:42 2016) by ROOT version5.34/05
   ...
   0->SetBinContent(1,0.9762002);
   0->SetBinContent(2,0.02304238);
   0->SetBinContent(3,0.0006925204);
   0->SetBinContent(4,5.193911e-05);
   0->SetBinContent(5,8.656517e-06);
   0->SetBinContent(6,4.328258e-06);
   0->SetMinimum(0);
   0->SetMaximum(0);
   0->SetEntries(231351);
   0->SetStats(0);
   ...
   ci = TColor::GetColor("#7293cb");
   0->SetLineColor(ci);
   0->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   1->SetBinContent(1,0.9915509);
   1->SetBinContent(2,0.008172194);
   1->SetBinContent(3,0.0002329875);
   1->SetBinContent(4,3.95639e-05);
   1->SetBinContent(5,4.395989e-06);
   1->SetMinimum(0);
   1->SetMaximum(0);
   1->SetEntries(227791);
   1->SetStats(0);
   ...
   ci = TColor::GetColor("#e1974c");
   1->SetLineColor(ci);
   1->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   2->SetBinContent(1,0.0191566);
   2->SetBinContent(2,0.9662132);
   2->SetBinContent(3,0.007364926);
   2->SetBinContent(4,0.0031441);
   2->SetBinContent(5,0.002127084);
   2->SetBinContent(6,0.001296189);
   2->SetBinContent(7,0.0006979463);
   2->SetBinContent(8,0.0007311818);
   2->SetMinimum(0);
   2->SetMaximum(0);
   2->SetEntries(150777);
   2->SetStats(0);
   ...
   ci = TColor::GetColor("#83ba5b");
   2->SetLineColor(ci);
   2->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   3->SetBinContent(1,0.03424269);
   3->SetBinContent(2,0.9528173);
   3->SetBinContent(3,0.008022671);
   3->SetBinContent(4,0.002500703);
   3->SetBinContent(5,0.001310198);
   3->SetBinContent(6,0.0007958222);
   3->SetBinContent(7,0.0003105639);
   3->SetBinContent(8,0.0002393931);
   3->SetMinimum(0);
   3->SetMaximum(0);
   3->SetEntries(309811);
   3->SetStats(0);
   ...
   ci = TColor::GetColor("#d35e60");
   3->SetLineColor(ci);
   3->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   4->SetBinContent(1,0.03520241);
   4->SetBinContent(2,0.9526958);
   4->SetBinContent(3,0.007751806);
   4->SetBinContent(4,0.0022419);
   4->SetBinContent(5,0.001249218);
   4->SetBinContent(6,0.0006023016);
   4->SetBinContent(7,0.0002565358);
   4->SetBinContent(8,0.0002230746);
   4->SetMinimum(0);
   4->SetMaximum(0);
   4->SetEntries(89589);
   4->SetStats(0);
   ...
   ci = TColor::GetColor("#808585");
   4->SetLineColor(ci);
   4->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   5->SetBinContent(1,0.0004340987);
   5->SetBinContent(2,0.003639215);
   5->SetBinContent(3,0.09986631);
   5->SetBinContent(4,0.8670846);
   5->SetBinContent(5,0.01768197);
   5->SetBinContent(6,0.007415792);
   5->SetBinContent(7,0.003877971);
   5->SetBinContent(8,0.0035741);
   5->SetMinimum(0);
   5->SetMaximum(0);
   5->SetEntries(138860);
   5->SetStats(0);
   ...
   ci = TColor::GetColor("#9067a7");
   5->SetLineColor(ci);
   5->GetXaxis()->SetTitle("Number of #pi^{-}");
   ...
   6->SetBinContent(1,0.0003263818);
   6->SetBinContent(2,0.004530937);
   6->SetBinContent(3,0.1102751);
   6->SetBinContent(4,0.8577588);
   6->SetBinContent(5,0.01729824);
   6->SetBinContent(6,0.006892395);
   6->SetBinContent(7,0.002918235);
   6->SetBinContent(8,0.001939094);
   6->SetMinimum(0);
   6->SetMaximum(0);
   6->SetEntries(52165);
   6->SetStats(0);
   ...
   ci = TColor::GetColor("#ab6857");
   6->SetLineColor(ci);
   6->GetXaxis()->SetTitle("Number of #pi^{-}");
