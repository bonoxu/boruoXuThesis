...
//=========  (Wed Aug 16 17:16:12 2017) by ROOT version5.34/05
   ...
   0->SetBinContent(1,0.005763198);
   0->SetBinContent(2,0.9941401);
   0->SetBinContent(3,9.671219e-05);
   0->SetMinimum(0);
   0->SetMaximum(1.1);
   0->SetEntries(227791);
   0->SetStats(0);
   ...
   1->SetBinContent(1,0.9714127);
   1->SetBinContent(2,0.02837658);
   1->SetBinContent(3,0.0002107609);
   1->SetMinimum(0);
   1->SetMaximum(1.1);
   1->SetEntries(52165);
   1->SetStats(0);
   ...
   leg->SetFillColor(10);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("0","#mu^{-}","f");
