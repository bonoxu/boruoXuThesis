...
{List of signal and background samples after pre-selection cuts at \rootS{1.4}.  The selection efficiencies are presented in a ``flow'' fashion. Every selection cut contains all the cuts to the left of it and all  cuts in \Table{tab:doubleHiggs1.4TeVPreslection} .}
