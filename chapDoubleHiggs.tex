...
\caption[\BeamCAL and \LumiCAL electron tagging efficiency.]%
   {Figure a) shows  500\,GeV electron tagging efficiency in the \BeamCAL as a function of polar angle, with different methods to model backgrounds: pregenerated and Gaussian,  and two methods to identify electrons:  clustering algorithm and  shower fitting algorithm, taken from \cite{Sailer:2017onh}. Figure b) shows the  electron tagging efficiency in the \LumiCAL as a function of the electron energy, for polar angle $\theta = 50$\,mrad, taken from \cite{Lukic:forwardElectron}. }
...
\end{tabular}
\caption{The performances of  lepton finders on the signal events and selected background events at \rootS{1.4}.  Numbers represent the fractions of events where no leptons are identified by the individual lepton finder.  \Pphoton(BS) represents a real photon from beamstrahlung (BS).}
...
\end{tabular}
\caption{The performances of  lepton finders on the signal events and selected background events at \rootS{3}.  Numbers represent the fractions of events where no leptons are identified by the individual lepton finder. \Pphoton(BS) represents a real photon from beamstrahlung (BS).}
...
\caption[Example MC mass fit for jet optimisation in double Higgs analysis]%
   {A typical example of  $m_{\Hbb}$  mass distribution for $R$ = 1.3 using loose PFO collection for signal samples at \rootS{3}.  Fitting function is superimposed in red. The arrow shows the fitted mean peak position. }
