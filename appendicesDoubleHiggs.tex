...
\end{tabular}
\caption
{List of signal and background events after each pre-selection cut at \rootS{3}.  The selection efficiencies are presented in a ``flow'' fashion. Every selection cut contains all the cuts to the left of it and all  cuts in \Table{tab:doubleHiggs3TeVPreslection}}
