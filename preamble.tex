...
\DeclareRobustCommand{\EQUATION}[1]{Equation \ref{#1}\xspace}
\DeclareRobustCommand{\Reference}[1]{reference \ref{#1}\xspace}
\DeclareRobustCommand{\REFERENCE}[1]{Reference \ref{#1}\xspace}
...
\DeclareRobustCommand{\decayRhoFinalState}{\Pgpm\Ppizero\Pgngt\xspace}
\DeclareRobustCommand{\decayRhoFinalStateShort}{\Pgpm\Ppizero\xspace}

\DeclareRobustCommand{\decayRho}{\rho\Pgngt\xspace}
\DeclareRobustCommand{\decayAi}{$a_1$\Pgngt\xspace}
\DeclareRobustCommand{\decayAiPhoton}{\HepParticleResonanceFull{a}{1}{}{\Pgpm\Pgpz\Pgpz}{}{}\Pgngt\xspace}
\DeclareRobustCommand{\decayAiPhotonFinalState}{\Pgpm\Pgpz\Pgpz\Pgngt\xspace}
\DeclareRobustCommand{\decayAiPhotonFinalStateShort}{\Pgpm\Pgpz\Pgpz\xspace}
\DeclareRobustCommand{\decayAiPion}{\HepParticleResonanceFull{a}{1}{}{\Pgpm\Pgpm\Pgpp}{}{}\Pgngt\xspace}
\DeclareRobustCommand{\decayAiPionFinalState}{\Pgpp\Pgpm\Pgpm\Pgngt\xspace}
\DeclareRobustCommand{\decayAiPionFinalStateShort}{\Pgpp\Pgpm\Pgpm\xspace}

\DeclareRobustCommand{\decayThreePionPhoton}{\Pgpp\Pgpm\Pgpm\Pgpz\Pgngt\xspace}
...
\DeclareRobustCommand{\decayThreePionPhotonShort}{\Pgpp\Pgpm\Pgpm\Pgpz\xspace}
...
\DeclareRobustCommand{\egamma}{\HepProcess{ \Pemp\Pgamma}\xspace}
\DeclareRobustCommand{\gammae}{\HepProcess{ \Pgamma\Pemp}\xspace}
...
\DeclareRobustCommand{\IsolatedLeptonFinderProcessor}{\textsc{IsolatedLeptonFinderProcessor}\xspace}
\DeclareRobustCommand{\TauFinderProcessor}{\textsc{TauFinderProcessor}\xspace}
 
 \DeclareRobustCommand{\WW}{\HepProcess{\PW\PW}\xspace}
\DeclareRobustCommand{\eeToHH}{\HepProcess{ \Pem \Pep \to \PHiggs \PHiggs \Pnue \APnue }\xspace}
...
\DeclareRobustCommand{\eeToHHbbWWFull}{\HepProcess{ \Pem \Pep \to \PHiggs \PHiggs \Pnue \APnue \to \Pbottom \APbottom \PWplus \PWminus}\xspace}
...
\DeclareRobustCommand{\eeToHHbbWWHadFull}{\HepProcess{ \PHiggs \PHiggs \Pnue \APnue \to \Pbottom \APbottom \PWplus \PWminus  \Pnue \APnue \to \Pbottom \APbottom \Pq \Pq \Pq \Pq \Pnue \APnue}\xspace}
...
\DeclareRobustCommand{\eeToHHbbbbFull}{\HepProcess{\Pem \Pep \to  \PHiggs \PHiggs  \Pnue \APnue \to \Pbottom \APbottom \Pbottom \APbottom  \Pnue \APnue}\xspace}
...
\DeclareRobustCommand{\normalPFO}{normal selected PFO collection\xspace}
...
\DeclareRobustCommand{\pp}{\HepProcess{\APproton\Pproton}\xspace}
