...
\titlespacing\subsubsection{-50pt}{12pt plus 4pt minus 2pt}{0pt plus 2pt minus 2pt}
...
\DeclareRobustCommand{\PartialStroke}{\mymath{\gamma^{\mu}\partial_{\mu}}\xspace}
...
\DeclareRobustCommand{\RMs}{Moli\`{e}re radii\xspace}
\DeclareRobustCommand{\rms}{root-mean-square\xspace}

\DeclareRobustCommand{\Zprime}{\HepParticle{Z}{}{\prime}\xspace}
\DeclareRobustCommand{\Zuds}{\HepProcess{ \PZ \to \Pup\APup/\Pdown\APdown/\Pstrange\APstrange}\xspace}
\DeclareRobustCommand{\eeZuds}{\HepProcess{ \Pep \Pem \to \PZ\PZ}\xspace events where \Zuds}
...
\DeclareRobustCommand{\ZForTauTau}{\uprightMath{\PZ_{\Ptau\Ptau}}\xspace}
\DeclareRobustCommand{\ZForqq}{\uprightMath{\PZ_{\Pquark\Pquark}}\xspace}
...
\DeclareRobustCommand{\btagFull}[2]{\mymath{B^{#1}_{#2}}\xspace}
\DeclareRobustCommand{\ctagFull}[2]{\mymath{C^{#1}_{#2}}\xspace}
...
\DeclareRobustCommand{\cosStar}[1]{\mymath{\cos{\theta^{*}_{#1}}}\xspace}
...
\DeclareRobustCommand{\HiggsTableFull}[2]{The table shows the signal and background events at \rootS{#1}, assuming an integrated luminosity of #2\,\uprightMath{fb^{-1}}. \Pquark can be \Pup, \Pdown, \Pstrange, \Pbottom or \Ptop. Unless specified, \Pquark, \Plepton and \Pnu represent either particles or the corresponding anti-particles.}
...
\DeclareRobustCommand{\Garlic}{\textsc{Garlic}\xspace}
