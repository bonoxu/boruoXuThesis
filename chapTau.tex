...
\end{equation}
where $m_{tot}$ is the invariant mass of the charged pion and two photons. The factor of 2 in \Equation{eqn:tauA1TwoPhoton2} is for the comparison with \Equation{eqn:tauA1TwoPhoton1}.
