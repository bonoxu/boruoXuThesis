...
Tau hadronically decay can also identified as a small jet. Here we use Durham algorithm \cite{Catani:1991hj}, also known as \ee \kt algorithm. (see \Section{sec:pandoraJetDurham}). The jet algorithm runs in exclusive mode to find four jets.
