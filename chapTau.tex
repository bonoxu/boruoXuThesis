...
\end{tabular}
\caption
{Fractions of tau decays passing successive cuts  for different tau decay final states.}%All cuts are based on the truth information.
