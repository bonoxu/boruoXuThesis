...
\end{subfigure}
\caption
{Reconstructed invariant mass distributions for a) \Ppizero; b) \Prho, in the \decayRhoShort decay mode. The reconstructed masses are obtained using the MC truth information to find the corresponding reconstructed particles. The decay mode is selected using the MC truth information. Area under the curve is normalised to 1.}
\label{fig:tauRho}
\end{figure}
