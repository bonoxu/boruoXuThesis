...
\end{subfigure}
\caption[The correct classification probabilities for hadronic tau decay final states  as a function of the \ECAL square cell sizes]
{
 The correct classification probabilities for hadronic tau decay final states  as a function of the \ECAL square cell sizes, using the nominal \ILD detector model with \sqrtS = 100, 200, 500 and 1000\,GeV. \FIGURE{fig:tauDecayMode2}, ~\ref{fig:decayMode3}, ~\ref{fig:decayMode3}, ~\ref{fig:decayMode4}, ~\ref{fig:decayMode5} show the  \decayPionShort,  \decayRhoShortest, \decayAiPhotonShortest, \decayAiPionShortest, \decayThreePionPhotonShort decay modes, respectively.}
