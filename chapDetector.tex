...
The \ILC and the \CLIC shares some common design features. Both colliders will be the linear colliders as oppose to the circular colliders like the \LHC. Detectors for both colliders will use the high granularity particle flow calorimetry \cite{Baer:2013cma,Linssen:2012hp}. The conceptual design of two the \CLIC detectors was based on the \ILC detectors. Two detectors have similar designs for the barrel and the endcap geometry. One of the major differences of two colliders is that the \ILC is designed to operate from 91\,GeV to 1\,TeV, while the \CLIC will cover a range of 350\,GeV to 3\,TeV. Due to the high energy of the beam in the \CLIC, reducing the photon-photon collision background would be a major consideration for the \CLIC detector. Another difference is that the separation of brunch crossing in the CLIC is shorter than it is in is the ILC.
...
One goal for jet energy resolution at a future linear collider it is to separate  \PW and \PZ bosons, by reconstructing the invariant mass via quark-jets using the hadronic decay channel. The idealised reconstructed \PW and \PZ boson mass distribution of different assumed jet mass resolutions is shown in \Figure{fig:detectorWZseparation}. As the invariant mass resolution is comparable to the gauge boson widths, i.e. $\sigma_m/m\approx\Gamma_{\PW}/m_{\PW}\approx\Gamma_{\PZ}/m_{\PZ}$, a separation of 2.5$\sigma$ implies a jet energy resolution of 3.5\,\% \cite{Thomson:2009rp} for a range of jet energies from 50\,GeV to 1\,TeV.
...
This level of precision is unlikely to be achieved with a traditional calorimetry design. A traditional energy flow approach to calorimetry measures jet energies as a sum of the energy in the calorimeters. The jet energy resolution is parameterised by:
\begin{equation}
