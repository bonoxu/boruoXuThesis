...
\caption
{Key parameters for vertex detector in the \ILC.  The table is adapted from \cite{Behnke:2013lya}.} %The spatial resolution ($\sigma$) and readout times are for the CMOS option.
...
The scintillator tiles provide both energy and position measurements. The transverse segmentation, chosen by optimisation studies \cite{Thomson:2009rp} is about 3$\times$3\,\uprightMath{cm^2}. This level of segmentation is sufficient to meet the requirement of the particle flow \cite{Behnke:2013lya}.
