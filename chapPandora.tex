...
Before discussing the rest of the \pandora reconstruction, it is necessary to introduce the cone based clustering algorithm, which is widely used in many reconstruction algorithms in the \pandora. The clustering algorithm produces basic working objects, \clusters.
