...
//=========  (Wed Feb 15 14:44:41 2017) by ROOT version5.34/05
   ...
   TH1F *THStack_stack_2 = new TH1F("THStack_stack_2","",40,0.2,1);
   THStack_stack_2->SetMinimum(0.01993334);
   THStack_stack_2->SetMaximum(2.815343e+07);
   THStack_stack_2->SetDirectory(0);
   THStack_stack_2->SetStats(0);
   THStack_stack_2->SetLineWidth(2);
   THStack_stack_2->SetMarkerSize(1.2);
   THStack_stack_2->GetXaxis()->SetTitle("Highest b-tag");
