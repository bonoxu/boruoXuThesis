...
//=========  (Wed Oct 21 09:31:08 2015) by ROOT version5.34/18
   TCanvas *c1 = new TCanvas("c1", "",12,51,1600,900);
   gStyle->SetOptStat(0);
   c1->SetHighLightColor(2);
   c1->Range(0.2682051,95.01926,1.39641,191.2521);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Graph",100,0.42,1.38);
   Graph_Graph37->SetMinimum(120.157);
   Graph_Graph37->SetMaximum(185.7856);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);
   Graph_Graph37->SetLineWidth(2);
   Graph_Graph37->SetMarkerSize(1.2);
   Graph_Graph37->GetXaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetXaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetXaxis()->SetLabelColor(ci);
   Graph_Graph37->GetXaxis()->SetLabelFont(42);
   Graph_Graph37->GetXaxis()->SetLabelOffset(0.0015);
   Graph_Graph37->GetXaxis()->SetLabelSize(0.06);
   Graph_Graph37->GetXaxis()->SetTitleSize(0.07);

   ci = TColor::GetColor("#212121");
   Graph_Graph37->GetXaxis()->SetTitleColor(ci);
   Graph_Graph37->GetXaxis()->SetTitleFont(42);
   Graph_Graph37->GetYaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetYaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetYaxis()->SetLabelColor(ci);
   Graph_Graph37->GetYaxis()->SetLabelFont(42);
   Graph_Graph37->GetYaxis()->SetLabelOffset(0.0015);
   Graph_Graph37->GetYaxis()->SetLabelSize(0.06);
   Graph_Graph37->GetYaxis()->SetTitleSize(0.07);
   Graph_Graph37->GetYaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph37->GetYaxis()->SetTitleColor(ci);
   Graph_Graph37->GetYaxis()->SetTitleFont(42);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetZaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph37->GetZaxis()->SetLabelColor(ci);
   Graph_Graph37->GetZaxis()->SetLabelFont(42);
   Graph_Graph37->GetZaxis()->SetLabelOffset(0.0015);
   Graph_Graph37->GetZaxis()->SetLabelSize(0.06);
   Graph_Graph37->GetZaxis()->SetTitleSize(0.07);
   Graph_Graph37->GetZaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph37->GetZaxis()->SetTitleColor(ci);
   ...
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Graph",100,0.42,1.38);
   Graph_Graph38->SetMinimum(118.1878);
   Graph_Graph38->SetMaximum(169.0646);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);
   Graph_Graph38->SetLineWidth(2);
   Graph_Graph38->SetMarkerSize(1.2);
   Graph_Graph38->GetXaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetXaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetXaxis()->SetLabelColor(ci);
   Graph_Graph38->GetXaxis()->SetLabelFont(42);
   Graph_Graph38->GetXaxis()->SetLabelOffset(0.0015);
   Graph_Graph38->GetXaxis()->SetLabelSize(0.06);
   Graph_Graph38->GetXaxis()->SetTitleSize(0.07);

   ci = TColor::GetColor("#212121");
   Graph_Graph38->GetXaxis()->SetTitleColor(ci);
   Graph_Graph38->GetXaxis()->SetTitleFont(42);
   Graph_Graph38->GetYaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetYaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetYaxis()->SetLabelColor(ci);
   Graph_Graph38->GetYaxis()->SetLabelFont(42);
   Graph_Graph38->GetYaxis()->SetLabelOffset(0.0015);
   Graph_Graph38->GetYaxis()->SetLabelSize(0.06);
   Graph_Graph38->GetYaxis()->SetTitleSize(0.07);
   Graph_Graph38->GetYaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph38->GetYaxis()->SetTitleColor(ci);
   Graph_Graph38->GetYaxis()->SetTitleFont(42);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetZaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph38->GetZaxis()->SetLabelColor(ci);
   Graph_Graph38->GetZaxis()->SetLabelFont(42);
   Graph_Graph38->GetZaxis()->SetLabelOffset(0.0015);
   Graph_Graph38->GetZaxis()->SetLabelSize(0.06);
   Graph_Graph38->GetZaxis()->SetTitleSize(0.07);
   Graph_Graph38->GetZaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph38->GetZaxis()->SetTitleColor(ci);
   ...
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Graph",100,0.42,1.38);
   Graph_Graph39->SetMinimum(113.49);
   Graph_Graph39->SetMaximum(138.5476);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);
   Graph_Graph39->SetLineWidth(2);
   Graph_Graph39->SetMarkerSize(1.2);
   Graph_Graph39->GetXaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetXaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetXaxis()->SetLabelColor(ci);
   Graph_Graph39->GetXaxis()->SetLabelFont(42);
   Graph_Graph39->GetXaxis()->SetLabelOffset(0.0015);
   Graph_Graph39->GetXaxis()->SetLabelSize(0.06);
   Graph_Graph39->GetXaxis()->SetTitleSize(0.07);

   ci = TColor::GetColor("#212121");
   Graph_Graph39->GetXaxis()->SetTitleColor(ci);
   Graph_Graph39->GetXaxis()->SetTitleFont(42);
   Graph_Graph39->GetYaxis()->SetNdivisions(506);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetYaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetYaxis()->SetLabelColor(ci);
   Graph_Graph39->GetYaxis()->SetLabelFont(42);
   Graph_Graph39->GetYaxis()->SetLabelOffset(0.0015);
   Graph_Graph39->GetYaxis()->SetLabelSize(0.06);
   Graph_Graph39->GetYaxis()->SetTitleSize(0.07);
   Graph_Graph39->GetYaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph39->GetYaxis()->SetTitleColor(ci);
   Graph_Graph39->GetYaxis()->SetTitleFont(42);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetZaxis()->SetAxisColor(ci);

   ci = TColor::GetColor("#616161");
   Graph_Graph39->GetZaxis()->SetLabelColor(ci);
   Graph_Graph39->GetZaxis()->SetLabelFont(42);
   Graph_Graph39->GetZaxis()->SetLabelOffset(0.0015);
   Graph_Graph39->GetZaxis()->SetLabelSize(0.06);
   Graph_Graph39->GetZaxis()->SetTitleSize(0.07);
   Graph_Graph39->GetZaxis()->SetTitleOffset(1.1);

   ci = TColor::GetColor("#212121");
   Graph_Graph39->GetZaxis()->SetTitleColor(ci);
