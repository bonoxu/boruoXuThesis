...
This chapter provides a theoretical overview which would be used in the subsequent  chapters. A short review of the Standard Model of Particle Physics, the current best particle theory, is provided, with an emphasis on the Higgs mechanism. A general parametrisation of the Higgs theory is discussed, and supplies the theoretical background for the physics analysis in the \Chapter{chap:DoubleHiggs}.
